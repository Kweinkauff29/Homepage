...
files.forEach(file => {
    if (path.extname(file) === '.html' && !file.includes('test')) {
        ...
        console.log(`Updated to FULL TRANSPARENCY bottom waves for ${file}`);
    }
});
