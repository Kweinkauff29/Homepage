...
if new_css in text and new_js in text:
    print('Education asset URLs are already using immutable jsDelivr assets')
elif old_css in text and old_js in text:
    ...
    raise RuntimeError('Education asset URLs are in an unexpected state')
